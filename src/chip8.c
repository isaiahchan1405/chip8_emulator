...
void emulate_cycle(chip8_t *chip8)
{
    ...
    case 0xC000: // Set Vx = random byte and kk
        chip8->V[(chip8->OP & 0x0F00) >> 8] = (rand() % (255 + 1)) & (chip8->OP & 0x00FF);
        break;

    case 0xD000:
    { // Replaces display with sprite; Detects collisions; Wraps sprites if out of bound
